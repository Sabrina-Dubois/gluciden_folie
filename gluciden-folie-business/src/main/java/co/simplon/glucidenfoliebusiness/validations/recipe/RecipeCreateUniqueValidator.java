...
public class RecipeCreateUniqueValidator 
	implements ConstraintValidator<RecipeCreateUnique, RecipeCreateDto> {

	//variable recipes qui est une insatnce de	recipeRepo
	//repo pour verif si une recette avec le meme nom existe
	private final RecipeRepository recipes;
	
	//constructeur pour injecter une instance de SpotRepository -> classe SpotCreateUniqueValidator
	...
	@Override
	public boolean isValid(RecipeCreateDto inputs,
