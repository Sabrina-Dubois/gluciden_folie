...
import co.simplon.glucidenfoliebusiness.validations.AccountCreateUnique;
...
public record AccountCreateDto(
		...
		@Size(min = 10, max = 50, message = "Le nom d'utilisateur doit contenir entre 10 et 50 caractères.") String username,
