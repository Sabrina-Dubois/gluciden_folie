<template>
	<v-container class="home-comp-container" fluid>
		...
		<v-card class="d-flex mb-4 flex-wrap" elevation="4">
			...
			<v-container fluid>
				<v-row class="recipe-row" align="center" justify="space-between">
					...
					>
						<v-card flat>
							...
							<v-card-actions class="d-flex">
								...
								<v-btn
									icon="mdi-heart"
									aria-label="$t('home.recipeOfTheDay.buttons.addToFavorites')"
								></v-btn>
								<v-btn
									icon="mdi-share-variant"
									aria-label="$t('home.recipeOfTheDay.buttons.shareRecipe')"
								></v-btn>
								<v-spacer></v-spacer>
							</v-card-actions>
						</v-card>
